...
(($, window, document) ->
  ...
  Plugin::init = ->
    ...
    if @options.pagination.active
      ...
      paginationCaptions = @data.paginationCaptions.split(',')
  ...
  Plugin::_setActive = (number) ->
    ...
    $(".slidesjs-pagination-item:eq(" + current + ")", $element).addClass "slidesjs-pagination-item_active"
